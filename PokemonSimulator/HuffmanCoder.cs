...
namespace PokemonSimulator
{
    ...
    public static partial class Grand
    {
        ...
        /// </summary>
        /// <remarks>
        /// The HuffmanCoder is a wrapper for a compression algorithem, effective at compressing larger strings that consist of as few unique characters as possible. 
        /// (json and xml are good candidates for this), If the provided string fills a large percentage of the source character set, say 80%, this compression algorithems output
        /// is likely to be larger than the original object. This algorithem compresses context-independant; i.e., the size of the resulting object should be hypothetically 
...
#warning Make this non static and have it mutate this instance's tree (maybe perhaps)
            ...
            #region Properties
            private string compressedObject;
            /// <summary>
            ...
            private string decompressedObject;
            /// <summary>
            ...
            private string Encode(string serialized)
            {
...
#warning ended optimization here.
        ...
        /// identical regardless of the order of the characters in the original string.
        /// </remarks>
        public class HuffmanCoder<T> where T : class
        {
            #region Typedefs
            /// <summary>
            /// DualNode is used to make the decryption/encryption tree for Huffman coding.
...
#warning Make this non static and have it mutate this instance's tree (maybe perhaps)
            ...
            #region Methods
            /// <summary>
            /// Converts the serialized object into a <see cref="HuffmanCoder{T}"/> compressed form.
            /// </summary>
            /// <param name="serialized">The serialized form of the object</param>
            /// <returns>The compressed form the of the object</returns>
            private string Encode(string serialized)
            ...
            /// <summary>
            /// Converts the compressed <see cref="HuffmanCoder{T}"/> object into its decompressed form.
            /// </summary>
            /// <param name="compressed">The compressed form of the object</param>
            /// <returns>The decompressed form the of the object</returns>
            private string Decode(string compressed)
            {
                StringBuilder result = new StringBuilder(string.Empty);
                StringBuilder tree = new StringBuilder(compressed.Substring(0, compressed.IndexOf("$D")));
                root = new DualNode(tree.ToString());//$D#$D[DATA]
                int firstD = compressed.IndexOf("$D");
                int secondD = compressed.IndexOf("$D", firstD + 1);
                uint whitespace = ((uint)compressed[firstD + 2]) - 60;
                string data = compressed.Substring(firstD + 5);
#warning ended optimization here.
                Queue<string> process = new Queue<string>();
                for (int i = 0; i < data.Length; i++)
                {
